...
// at progress i/(N-1), eased-interpolated between consecutive shots. No
// hold/dwell plateau -- scroll maps to camera motion the entire way, with
// smoothstep only softening the very start/end of each shot-to-shot leg.
